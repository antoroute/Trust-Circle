...
- [Décision et recherche cryptographique V3](security/CRYPTOGRAPHY_V3_DECISION.md)
...
- Sécurité : [menaces](security/THREAT_MODEL.md), [invariants](security/SECURITY_INVARIANTS.md), [frontière réseau et quotas](security/NETWORK_BOUNDARY.md), [journalisation sûre](security/LOGGING_POLICY.md), [vue du protocole](security/CRYPTO_PROTOCOL.md), [spécification V2 observée](security/CRYPTOGRAPHY_V2.md), [décision/recherche V3](security/CRYPTOGRAPHY_V3_DECISION.md), [preuve de confiance des appareils V1](security/DEVICE_TRUST_PROTOCOL_V1.md)
