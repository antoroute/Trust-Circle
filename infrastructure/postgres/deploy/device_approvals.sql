-- Deploy trust-circle:device_approvals to pg
-- requires: account_device_trust
...
CREATE TABLE device_approval_challenges (
  ...
  approver_identity_key_version INT NOT NULL
    CHECK (approver_identity_key_version >= 1),
  approver_identity_public_key BYTEA NOT NULL,
  target_device_id UUID NOT NULL,
  target_identity_key_version INT NOT NULL
    CHECK (target_identity_key_version >= 1),
